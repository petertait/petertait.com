...
class Pebble extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <HeroFeature
          headline="Startups + Enterprise Unite"
          image="pebble"
        ...
        <Container>
          <Column width="full">
            <Block type="process" border="solid" title="Process">
              <Process title="Discover" items={processDiscover} />
              <Process title="Analyse" items={processAnalyse} />
              <Process title="Develop" items={processDevelop} />
              <Process title="Outcome" items={processOutcome} />
            </Block>
          </Column>
          <Column width="third" headline="Bold and uncomplicated design." />
          <Column width="twoThird" content={DesignContent} />
          <Column width="full">
            <Media
              media="image"
        ...
        <hr />
        <Container>
          <Column width="third" headline="666% traffic increase? Not bad." />
          <Column width="twoThird" content={ResultsContent} />
          <Column width="full">
            <Media
              media="image"
              position="marginBottomNegative"
        ...
        <Container>
          ...
          />
          <Column width="twoThird" content={PerformanceContent} />
          <Column width="full">
            <Media
              media="image"
              position="marginBottomNegative"
        ...
        <Container>
          ...
          />
          <Column width="twoThird" content={IllustrationsContent} />
          <Column width="full">
            <Media
              media="image"
        ...
        <hr />
        <Container>
          <Column width="full" headline="Related projects">
            <BlockGrid

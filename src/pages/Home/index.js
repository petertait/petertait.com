  ...
  render() {
    return (
      <div>
        ...
        <hr />
        <Container>
          <Column width="full" display="flex" title="Services">
            <BlockFeature
              width="third"
            ...
            <BlockFeature
              ...
              title="App, VR &amp; website design"
              summary="User-centered software design. Using Agile methods to produce quick and effective results."
            />
            <BlockFeature
              width="third"
        ...
        <hr />
        <Container>
          <Column width="full" title="Selected Work">
            <ListItem
            ...
            <ListItem
              ...
              summary="Creation of a new way in educating a workforce remotely for Pearson Education."
              link="work/remote-education"
            />
            <ListItem
              title="Global People Search"
              summary="An iOS app for searching colleagues within a AstraZeneca."

...
<section class="blog-post-wrap wrap">
	...
	<div class="container">
	 ...
	 <!-- /.container -->
	 <!-- .next-post -->
	 <a href="<?php echo html($page->prevVisible()->url()) ?>" class="next-post" title="<?php echo html($page->prevVisible()->title()) ?>">
	 	<div class="container">
	 		<div class="grid">
	 			<h4 class="unit span-grid">Read next</h4>
	 			<h2 class="unit span-grid"><?php echo html($page->prevVisible()->title()) ?></h2>
	 		</div>
	 	</div>
	 </a>
	 <!-- /.next-post -->
